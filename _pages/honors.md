...
<style>
  ...
  /* Relevant coursework — neutral standout box, two side-by-side columns (no accent color) */
  .edu-courses { margin-top: .9rem; padding: .7rem .95rem; border: 1px solid rgba(128,128,128,.25); background: rgba(128,128,128,.08); border-radius: .3rem; }
